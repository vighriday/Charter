...
window.CHARTER_SERVICES = {
  "companies": [
    ...
    },
    {
      ...
      "stillNotTrue": "There is no client for this yet, and no key. A run says so and shows the words it would have sent, so a reader can see exactly what would have been drawn."
    },
    {
